...
public class MainPanel extends JPanel {
    ...
    public MainPanel() {
        ...
        one.setBounds(TimeThread1.x, TimeThread1.y, 50, 50);
        two.setBounds(TimeThread2.x, TimeThread2.y, 50, 50);
        three.setBounds(TimeThread3.x, TimeThread3.y, 50, 50);
        four.setBounds(TimeThread4.x, TimeThread4.y, 50, 50);
        ...
        start.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (start.getText() == "暂停") {
                    TimeThread1.flag = false;
                    TimeThread2.flag = false;
                    TimeThread3.flag = false;
                    TimeThread4.flag = false;
                    start.setText("继续");
                } else {
                    TimeThread1.flag = true;
                    TimeThread2.flag = true;
                    TimeThread3.flag = true;
                    TimeThread4.flag = true;
                    start.setText("暂停");
                }
            }
        });
        ...
        reset.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TimeThread3.x = 100;
                TimeThread4.x = 100;
                one.setLocation(TimeThread1.x, TimeThread1.y);
                two.setLocation(TimeThread2.x, TimeThread2.y);
                three.setLocation(TimeThread3.x, TimeThread3.y);
                four.setLocation(TimeThread4.x, TimeThread4.y);
